...
import { FileText, ShoppingCart, LayoutDashboard, Users, LogOut, Menu, FileSignature, Settings, TrendingUp, Calculator } from "lucide-react";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const getNavigationItems = () => {
    ...
    if (["admin", "manager", "staff"].includes(userRole)) {
      items.push({ title: "Rebate Calculator", url: createPageUrl("RebateSettings" as any), icon: Calculator });
    }
